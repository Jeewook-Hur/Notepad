//ShiftDownKey.cpp
/*
* 파일명칭:ShiftDownKey.cpp
* 기능:shift와 아래쪽 화살표를 클릭했을때의 전략
* 작성자:허지욱
* 작성일자:2022/10/31
*/
...
* 기능:생성자
*/
ShiftDownKey::ShiftDownKey(Notepannel* notepannel) {
...
*/
void ShiftDownKey::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) {
...
#if 0
	DownKey downKey(this->notepannel);
	Glyph* currentLine = NULL;
	Long lineOrder = -1;
	Long charIndex = -2;
