//CtrlShiftBackspaceKey.cpp
/*
* 파일명칭:CtrlShiftBackspaceKey.cpp
* 기능:컨트롤 쉬프트 백스페이스 키를 눌렀을때의 전략
* 작성자:허지욱
* 작성일자:2022/11/15
*/
...
/*
* 함수명칭:CtrlShiftBackspaceKey
* 기능:생성자
*/
CtrlShiftBackspaceKey::CtrlShiftBackspaceKey(Notepannel* notepannel) {
...
* 기능:소멸자
*/
CtrlShiftBackspaceKey::~CtrlShiftBackspaceKey() {
}
...
*/
void CtrlShiftBackspaceKey::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) {
