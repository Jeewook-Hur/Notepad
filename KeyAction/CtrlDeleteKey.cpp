//CtrlDeleteKey.cpp
/*
* 파일명칭:CtrlDeleteKey.cpp
* 기능:컨트롤 딜리트 키를 눌렀을때의 전략
* 작성자:허지욱
* 작성일자:2022/11/15
*/
...
* 기능:생성자
*/
CtrlDeleteKey::CtrlDeleteKey(Notepannel* notepannel) {
...
*/
void CtrlDeleteKey::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) {
